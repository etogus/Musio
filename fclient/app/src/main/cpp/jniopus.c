...
Java_com_mamedovga_rpo_Opus_initEncoder(JNIEnv *env, jobject instance, jint samplingRate,
...
Java_com_mamedovga_rpo_Opus_encodeBytes(JNIEnv *env, jobject instance, jshortArray in,
                                               jbyteArray out) {
...
JNIEXPORT jboolean JNICALL
Java_com_mamedovga_rpo_Opus_releaseEncoder(JNIEnv *env, jobject instance) {
...
JNIEXPORT jboolean JNICALL
Java_com_mamedovga_rpo_Opus_initDecoder(JNIEnv *env, jobject instance, jint samplingRate,
...
JNIEXPORT jint JNICALL
Java_com_mamedovga_rpo_Opus_decodeBytes(JNIEnv *env, jobject instance, jbyteArray in,
                                               jshortArray out) {
...
JNIEXPORT jboolean JNICALL
Java_com_mamedovga_rpo_Opus_releaseDecoder(JNIEnv *env, jobject instance) {
